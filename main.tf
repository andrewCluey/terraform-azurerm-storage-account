...
resource "azurerm_private_endpoint" "pe" {
  ...
  private_dns_zone_group {
    name                 = data.azurerm_dns_zone.private_blob_dns_zone.name
    private_dns_zone_ids = [data.azurerm_dns_zone.private_blob_dns_zone.id]
  }
}

data "azurerm_dns_zone" "private_blob_dns_zone" {
  name                = var.blob_dns_zone_name
  resource_group_name = var.blob_dns_zone_rg_name
}
